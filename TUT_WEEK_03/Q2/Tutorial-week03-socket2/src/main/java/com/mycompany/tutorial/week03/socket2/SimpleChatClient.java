...
public class SimpleChatClient{
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("[CLIENT] -  client was connected to the server");
            ...
            /* **Enter an infinite loop where the client will continuously send messages to the server and receive responses.** */
                ...
                outputStram.write(message.getBytes());
                ...
                String serverResponse = new String(buffer,0,totalBytes);
                /* **Print the server's response to the console.** */
                
                    System.out.println("[CLIENT] : server said : " + serverResponse);
